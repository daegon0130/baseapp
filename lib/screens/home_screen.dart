import 'package:baseapp/repositories/announcement.dart';
import 'package:baseapp/repositories/update_info.dart';
import 'package:baseapp/utils/version_utils.dart';
import 'package:baseapp/widget/announcement_dialog.dart';
import 'package:baseapp/widget/update_info_dialog.dart';
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) async {
      try {
        ...
        debugPrint('공지사항 또는 업데이트 정보 불러오기 실패: $e');
      }
    });
  }
