...
import 'package:baseapp/models/update_info.dart';
    ...
    return AlertDialog(
      ...
      content: SingleChildScrollView(
        child: Column(
          ...
          children: [Text(updateInfo.content)],
        ),
      ),
      actions: [
        ...
        TextButton(
          onPressed: () async {
            if (Platform.isIOS) {
              await launchUrl(
                Uri.parse(updateInfo.appstoreUrl ?? 'https://apps.apple.com/'),
              );
            } else if (Platform.isAndroid) {
              await launchUrl(
                Uri.parse(
                  updateInfo.playstoreUrl ?? 'https://play.google.com/',
                ),
              );
            }
          },
